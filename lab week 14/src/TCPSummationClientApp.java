...
public class TCPSummationClientApp {
	...
	public static void main(String[] args) {
		...
		try {
			...
			int resultmultiply = dis.readInt();
			int resultsum = dis.readInt();
			
			// 5. Further processing - display the result for multiplication
			System.out.println("\tSending to the server: " + number1 + ", " 
					+ number2 + ", " + number3);
			System.out.println("\tReceiving from server: " + resultmultiply);
			
			// 5. Further processing - display the result for summation
			System.out.println("\tSending to the server: " + number1 + ", " 
					+ number2 + ", " + number3);
			System.out.println("\tReceiving from server: " + resultsum);
